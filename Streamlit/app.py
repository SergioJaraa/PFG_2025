...
with col2:
    ...
    @st.cache_resource
    def load_stylegan_model(pkl_url):
        with urllib.request.urlopen(pkl_url) as f:
            G = pickle.load(f)['G_ema'].cuda()  # Load generator
        return G
    ...
    models = {
        "Glioma": "https://huggingface.co/SergioJaraa/MRI_Tumor_StyleGAN2/resolve/main/glioma_model.pkl",
        "Meningioma": "https://huggingface.co/SergioJaraa/MRI_Tumor_StyleGAN2/resolve/main/meningioma_model.pkl",
        "Pituitary": "https://huggingface.co/SergioJaraa/MRI_Tumor_StyleGAN2/resolve/main/pituitary_model.pkl"
    }
